...
pre_period = (data['REF_DATE'] >= '1990-01-01') & (data['REF_DATE'] < '1995-01-01')  
post_period = (data['REF_DATE'] >= '1995-01-01') & (data['REF_DATE'] <= '2005-12-31')  
...
plt.title('Difference-in-Differences (DID) Analysis: Employment Trends (1990-2005)')
plt.xticks([0, 1], ['Pre-Treatment (1990-1994)', 'Post-Treatment (1995-2005)'])
plt.xlabel('Period')
...
plt.tight_layout()
plt.savefig('did_employment_intervention_effects.png')
plt.show()
