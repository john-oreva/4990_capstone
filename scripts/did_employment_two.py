...
pre_period = (data['REF_DATE'] >= '2000-01-01') & (data['REF_DATE'] < '2006-01-01') 
post_period = (data['REF_DATE'] >= '2006-01-01') & (data['REF_DATE'] <= '2015-12-31')  
...
with open('did_regression_bubble_2.txt', 'w') as f:
...
plt.title('Difference-in-Differences (DID) Analysis: Employment Trends (2000-2015)', fontsize=14)
plt.xticks([0, 1], ['Pre-Treatment (2000–2005)', 'Post-Treatment (2006–2015)'])
plt.xlabel('Period')
